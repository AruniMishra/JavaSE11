public class Recap {
    ...
    public static void StringConstructors() {
        ...
        /*
         Whenever we create a String Object, two objects will be created i.e.
    ...
    public static void StringConstructorsInterned() {
        ...
        /*
         it refers to the same object which is in the SCP area because the content is already available in the SCP area.
